...
// ************************************************************************
oxoo2a::GPS::GPS ( HardwareSerial *_gps_channel ) {
	gps_channel = _gps_channel;
	n_entries = 0;
}

// ************************************************************************
void oxoo2a::GPS::Init ( uint16_t baud ) {
...
// ************************************************************************
void oxoo2a::GPS::SendCommand ( char *command ) {
...
// ************************************************************************
void oxoo2a::GPS::GPSEmptyChannel () {
	char c;
...
//
// ************************************************************************
char *oxoo2a::GPS::GPSMessage ( char *pattern, bool cooked = true ) {
	byte check = 0;
...
// ************************************************************************
char *oxoo2a::GPS::MessageEntry ( uint8_t index ) {
	if (index < n_entries)
		return entry[index];
	return NULL;
}
