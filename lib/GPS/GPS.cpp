...
namespace oxoo2a {
	...
	// ************************************************************************
	GPS::GPS ( HardwareSerial *_gps_channel ) {
	...
	//
	// ************************************************************************
	char *GPS::GPSMessage ( char *pattern, bool cooked = true ) {
		byte check = 0;
	...
	// ************************************************************************
	char *GPS::MessageEntry ( uint8_t index ) {
		if (index < n_entries)
			return entry[index];
		return NULL;
	}
